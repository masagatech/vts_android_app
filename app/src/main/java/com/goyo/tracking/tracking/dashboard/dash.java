package com.goyo.tracking.tracking.dashboard;
...
import com.goyo.tracking.tracking.forms.mytripsandkids;
import com.goyo.tracking.tracking.forms.reportmilege;
import com.goyo.tracking.tracking.forms.history;
import com.goyo.tracking.tracking.forms.reportspeed;
import com.goyo.tracking.tracking.forms.viewfuelentry;
import com.goyo.tracking.tracking.forms.viewvehicles;
import com.goyo.tracking.tracking.globals.Global;
import com.goyo.tracking.tracking.info.About;
...
import com.goyo.tracking.tracking.settings.VehicleSettings;
...
//                Manifest.permission.CAMERA,
    ...
    @OnClick(R.id.fuelform)
    void fuelform_click() {
        Intent intent = new Intent(this, viewfuelentry.class);
        startActivity(intent);
    }

    @OnClick(R.id.viewmykids)
    void viewmykids_click() {
        Intent intent = new Intent(this, mytripsandkids.class);
        startActivity(intent);
    }
...
//        }
        new AlertDialog.Builder(dash.this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        //calling logout api
                    if(!SHP.get(dash.this, SHP.ids.signedact,"normal").equals("normal")) {
                        signOutGoogle();
                        signOutFaceBook();
                        gotoLogin();
                        return;
    ...
    private void gotoLogin(){
        ...
        Intent i = new Intent(dash.this, com.goyo.tracking.tracking.initials.login.class);
        removeSubscription();
