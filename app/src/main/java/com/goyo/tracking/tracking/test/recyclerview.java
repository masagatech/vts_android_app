package com.goyo.tracking.tracking.test;
...
public class recyclerview extends AppCompatActivity {
    ...
    private ArrayList<RowData> generateData() {
        ...
        for (int i = 0; i < 350; i++)
            arrayList.add(new RowData(System.currentTimeMillis() + 60 * 1000 * (i * 2), "Item : " + i));
        return arrayList;
    }
    ...
    private class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new MyViewHolder(LayoutInflater.from(recyclerview.this).inflate(android.R.layout.simple_list_item_2, parent, false));
        }
