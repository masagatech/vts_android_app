package com.goyo.tracking.tracking.settings;
...
import com.goyo.tracking.tracking.adapters.vh_settings_adapter;
...
public class VehicleSettings extends AppCompatActivity {
    ...
    private void bindvehicles() {
        ...
        adapter.setOnItemClickLitner(new vh_settings_adapter.onItemClickLitner() {
            @Override
            public void onClick(vehiclesettings_model vhid) {
...
//        touchHelper.attachToRecyclerView(recyclerView);
    ...
    private void getVehicleDetails(vehiclesettings_model vhid) {

        String url =  !Global.getLoginType(VehicleSettings.this, "normal") ? Global.urls.getVehicleDetails.value: Global.urls.getVehicleDetails_vts.value;

        JsonObject json = new JsonObject();
        json.addProperty("flag", "vhdetail");
        json.addProperty("id", vhid.getVhId());
        json.addProperty("vtsid", vhid.getImei());
        Ion.with(this)
                .load(url)
